...
async function writeExif(media, data) {
    ...
    if (data) {
        ...
        const wr = { a: global.author ? global.author : 'maxis-dev', b: data.packname ? data.packname : global.packname ? global.packname : 'Bot WhatsApp', c: data.author ? data.author : global.author ? global.author : 'Maxisdev', d: data.categories ? data.categories : [''], e: data.isAvatar ? data.isAvatar : 0 }
