...
const expiredCheck = (maxis, _dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            maxis.sendMessage(_dir[position].id, { text: `Masa sewa di grup ini telah habis, bot otomatis keluar!` })
            .then( res => {
              maxis.groupLeave(_dir[position].id)
